...
FileBrowser::FileBrowser ( const QString &sFilter, bool onlyDirs, QString arg1, QWidget* arg2, unsigned int arg3, ZSkinService::WidgetClsID arg4 )        : ZListBox ( arg1, arg2, arg3, arg4 )
{
  sFileName = "";
  nameFilter = sFilter;
...
QString FileBrowser::getProgramDir ( const QString &AFileName )
{
...
bool FileBrowser::makedir(const QString &ASource, const QString &AName)
{
...
QString FileBrowser::RealName(const QString &AFileName)
{
  QString str = AFileName;
  ZConfig cini(ProgramDir + "/foldername.cfg", true);	
