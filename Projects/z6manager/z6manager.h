...
class Z6Man : public ZKbMainWidget
{
  ...
  public slots:
	...
	void AMupdate( const QString &AppId, const QString &DestMenuId, int pos, int lugar );
	void AMupdate2( const QString &AppId, const QString &DestMenuId );
