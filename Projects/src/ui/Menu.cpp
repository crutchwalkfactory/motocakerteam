			...
			case SDL_MOUSEBUTTONUP:
				...
				switch (event.key.keysym.sym){
					case SDLK_ESCAPE:
						...
						break;
					/*case SDLK_UP:
						mousey = mousey -3; if ( mousey < 0 ) mousey = 0;
						break;
					case SDLK_DOWN:
						mousey= mousey +3; if ( mousey > 240 ) mousey = 240; 
						break;
					case SDLK_RIGHT:
						mousex = mousex +3; if ( mousex > 320 ) mousex = 320; 
						break;
					case SDLK_LEFT:
						mousex = mousex -3; if ( mousex < 0 ) mousex = 0; 
						break;*/
