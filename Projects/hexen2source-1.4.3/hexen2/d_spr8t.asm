...
; $Id: d_spr8t.asm,v 1.6 2008/03/16 14:30:46 sezero Exp $
;
...
; C-shared globals:
 _sym_prefix D_SpriteSpansStartT
 _sym_prefix D_SpriteDrawSpansT
 _sym_prefix D_SpriteSpansEndT
 _sym_prefix R_TranPatch4
%endif	; _sym_prefix
...
LClampReentry5:
 ...
 imul  dword [reciprocal_table-8+ecx*4]
LSetEntryvec:
 mov ebx, dword [spr8Tentryvec_table+ecx*4]
 mov eax,edx
 push ebx
 mov ecx,ebp
 sar ecx,16
...
;;;;;;;;;;;;;;;;;;;;;;;;
; globals Spr8Entry?_8T
;;;;;;;;;;;;;;;;;;;;;;;;

 global Spr8Entry2_8T
Spr8Entry2_8T:
 sub edi,6
 sub ecx,12
 mov al, byte [esi]
 ...
 global Spr8Entry3_8T
Spr8Entry3_8T:
 sub edi,5
 sub ecx,10
 jmp LLEntry3_8

 global Spr8Entry4_8T
Spr8Entry4_8T:
 sub edi,4
 sub ecx,8
 jmp LLEntry4_8

 global Spr8Entry5_8T
Spr8Entry5_8T:
 sub edi,3
 sub ecx,6
 jmp LLEntry5_8

 global Spr8Entry6_8T
Spr8Entry6_8T:
 sub edi,2
 sub ecx,4
 jmp LLEntry6_8

 global Spr8Entry7_8T
Spr8Entry7_8T:
 dec edi
 sub ecx,2
 jmp LLEntry7_8

 global Spr8Entry8_8T
Spr8Entry8_8T:
 cmp bp, word [ecx]
 jl Lp9
 mov ah, byte [esi]
