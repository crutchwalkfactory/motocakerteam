...
; $Id: d_polysa3.asm,v 1.8 2008/03/20 14:07:53 sezero Exp $
;
...
; C-shared globals:
 _sym_prefix D_PolysetAff8StartT2
 _sym_prefix D_PolysetCalcGradientsT2
 _sym_prefix D_PolysetRecursiveTriangleT2
 _sym_prefix D_PolysetDrawSpans8T2
 _sym_prefix D_Aff8PatchT2
 _sym_prefix D_PolysetDrawT2
 _sym_prefix D_PolysetScanLeftEdgeT2
 _sym_prefix D_PolysetDrawFinalVertsT2
 _sym_prefix D_DrawNonSubdivT2
 _sym_prefix D_PolysetAff8EndT2
 _sym_prefix R_TranPatch2
%endif	; _sym_prefix
...
;;;;;;;;;;;;;;;;;;;;;;;;
; D_PolysetAff8StartT2
;;;;;;;;;;;;;;;;;;;;;;;;
 global D_PolysetAff8StartT2
D_PolysetAff8StartT2:

;;;;;;;;;;;;;;;;;;;;;;;;
; D_PolysetCalcGradientsT2
;;;;;;;;;;;;;;;;;;;;;;;;

 global D_PolysetCalcGradientsT2
D_PolysetCalcGradientsT2:
 fild dword [r_p0+0]
 fild dword [r_p2+0]
 fild dword [r_p0+4]
...
;;;;;;;;;;;;;;;;;;;;;;;;
; D_PolysetRecursiveTriangleT2
;;;;;;;;;;;;;;;;;;;;;;;;

 global D_PolysetRecursiveTriangleT2
D_PolysetRecursiveTriangleT2:
 push ebp
 push esi
 push edi
...
LDraw:
 ...
 mov ebp, dword [4+esp]
 mov cl, byte [eax+edx]  ; texture pixel
 or cl,cl
 jz Skip1B  ; color 0 = no draw
 mov edx, dword [d_pcolormap]
 mov dh, byte [edx+ecx]
 mov eax, dword [0+esp]
 add eax, dword [d_scantable+ebp*4]
 add eax, dword [d_viewbuffer]
 bt cx,0
 jnc Skip1
...
LNoDraw:
 ...
 push ebx
 push edi
 call D_PolysetRecursiveTriangleT2	; call near D_PolysetRecursiveTriangleT2
 mov ebx,esp
 push esi
 push ebx
 push edi
...
;;;;;;;;;;;;;;;;;;;;;;;;
; D_PolysetDrawSpans8T2
;;;;;;;;;;;;;;;;;;;;;;;;

 global D_PolysetDrawSpans8T2
D_PolysetDrawSpans8T2:
 push esi
 push ebx
...
;;;;;;;;;;;;;;;;;;;;;;;;
; D_PolysetScanLeftEdgeT2
;;;;;;;;;;;;;;;;;;;;;;;;

 global D_PolysetScanLeftEdgeT2
D_PolysetScanLeftEdgeT2:
 push ebp
 push esi
 push edi
...
L_PDFVertT2:
 ...
 shr edx,16
 mov dl, byte [edi+edx]   ; texture pixel
 or dl,dl
