...
class ZUNS_NotifyDlg
{
  Q_OBJECT
  public:
	ZUNS_NotifyDlg::ZUNS_NotifyDlg(UNS_PRIO_T,QString const&,QString const&,QWidget *, char const*);
...
class SETUP_Utility
{
  public:
	...
	const int getSoundVolume(ENUM_SOUND_TYPE_E);
	int setSoundVolume(ENUM_SOUND_TYPE_E,int);
	void setSpeakerVolume(int);
	void setLcdBacklightColor(int);
