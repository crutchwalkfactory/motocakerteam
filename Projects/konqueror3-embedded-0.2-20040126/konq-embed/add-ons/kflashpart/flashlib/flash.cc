...
#include "swf.h"
#if !defined(DISABLE_UNAVAILABLE_DEPTHS)
#include "graphic16.h"
#include "graphic24.h"
#endif
#include "graphic32.h"
...
#ifdef RCSID
static char *rcsid = "$Id: flash.cc,v 1.3 2003/05/26 13:22:20 montanaro Exp $";
#endif
...
long FlashGraphicInit(FlashHandle flashHandle, FlashDisplay *fd)
{
	...
	switch (fd->bpp) {
		case 4:
			...
			break;
#if !defined(DISABLE_UNAVAILABLE_DEPTHS) 
	        // Qt is currently limited to 1, 8, or 32 bit display. Removing unsupported depth
		case 3:
