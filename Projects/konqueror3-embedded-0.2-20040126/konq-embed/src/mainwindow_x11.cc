...
#if !defined(KONQ_GUI_KIOSK) && !defined(KONQ_GUI_TV)
...
void MainWindowX11::initGUI()
{
    ...
    qa = new QAction( loadPixmap( new_xpm ), i18n( "Open new View" ), 
		      CTRL + Key_N, m_changeable, "file_new" );
    qa->addTo( mm );
    ...
    qa = new QAction( loadPixmap( find_xpm ), i18n( "Find in Document" ), 
		      CTRL+Key_F, m_changeable, "edit_find" );
    qa->addTo( mm );

    mm->insertSeparator();

    qa = new QAction( loadPixmap( configure_xpm ), i18n( "Preferences..." ), 
		      0, m_changeable, "options_configure" );
    qa->addTo( mm );
    ...
    {
	qa = new QAction( loadPixmap( bookmark_add_xpm ), i18n( "Add Bookmark" ), 
			  CTRL+Key_B, m_changeable, "bookmark_add" );
	qa->addTo( mm );

	qa = new QAction( loadPixmap( bookmark_xpm ), i18n( "Edit Bookmarks..." ), 
			  0, m_changeable, "bookmark_edit" );
	qa->addTo( mm );
    ...
    qa = new QAction( loadPixmap( next_xpm ), i18n( "Next View" ), 
		      CTRL + Key_Tab, m_changeable, "view_next" );
    qa->addTo( mm );

    qa = new QAction( loadPixmap( close_xpm ), i18n( "Close View" ), 
		      CTRL + Key_W, m_changeable, "view_close" );
    qa->addTo( mm );
    ...
    qa = new QAction( loadPixmap(back_xpm), i18n( "Backward" ), 
		      ALT + Key_Left, m_changeable, "go_back" );
    qa->addTo( tb );

    qa = new QAction( loadPixmap( forward_xpm ), i18n( "Forward" ),
		      ALT + Key_Right, m_changeable, "go_forward" );
    qa->addTo( tb );

    qa = new QAction( loadPixmap( gohome_xpm ), i18n( "Home Page" ), 
		      CTRL + Key_Home, m_changeable, "go_home" );
    qa->addTo( tb );

    qa = new QAction( loadPixmap( reload_xpm ), i18n( "Reload" ), 
		      Key_F5, m_changeable, "view_redisplay" );
    qa->addTo( tb );

    qa = new QAction( loadPixmap( stop_xpm ), i18n( "Stop Loading" ), 
		      0, m_changeable, "go_stop" );
    qa->addTo( tb );

    qa = new QAction( loadPixmap( lock_xpm ), i18n( "Show Security Information" ), 
		      0, m_changeable, "info_security" );
    qa->addTo( tb );
    ...
    qa = new QAction( loadPixmap( images_display_xpm ), i18n( "Load Images" ), 
		      0, m_changeable, "view_load_images" );
    qa->addTo( tb );
