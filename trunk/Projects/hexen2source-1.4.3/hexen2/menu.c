/*
	...
	$Header: /cvsroot/uhexen2/hexen2/menu.c,v 1.106 2007/12/20 21:37:27 sezero Exp $
*/
...
#else
	M_PrintWhite (16 + (7 * 8), y + 16,	"  Motocaker Team  " HOT_VERSION_STR);
#endif
	M_PrintWhite (16 +(13 * 8), y + 24,	"Rokr z6 Port");
	y += 40;
