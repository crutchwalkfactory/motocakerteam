/*
	...
	$Id: progdefs.h,v 1.7 2008/01/22 17:45:28 sezero Exp $
*/
...
/* crc for Hexen II v1.09 progs.dat headers	*/
#define	PROGS_V109_CRC		38488
/* IMPORTANT: Although the crc values are the same
 * for 1.09 && 1.11 progs headers, their internals
 * do have one major difference:  the builtin #89,
 * endeffect(), takes no arguments in 1.09, but it
 * takes two float arguments in 1.11. As a result,
 * a v1.09 progs.dat might work incorrectly in the
 * current engine (see pr_cmds.c, PF_endeffect)...
 */
