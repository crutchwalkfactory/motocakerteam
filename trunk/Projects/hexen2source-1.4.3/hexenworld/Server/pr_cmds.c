/*
	...
	$Header: /cvsroot/uhexen2/hexenworld/Server/pr_cmds.c,v 1.41 2008/03/04 21:36:22 sezero Exp $
*/
...
// send message to all clients on this server
	...
	for (j = 0, client = svs.clients; j < MAX_CLIENTS; j++, client++)
	{
		if (client->state == cs_spawned)
		{
			...
			MSG_WriteString (&client->netchan.message, sv.lightstyles[style]);
		}
	}
}
...
static void PF_lightstylestatic(void)
{
	...
	for (i = 0, client = svs.clients; i < MAX_CLIENTS; i++, client++)
	{
		if (client->state == cs_spawned)
		{
			...
			MSG_WriteString (&client->netchan.message, sv.lightstyles[styleNumber]);
		}
	}
}
...
static int PaladinExp[MAX_LEVELS+1] =
{
	0,	// Level 1
	500,	// Level 2
	1000,	// Level 3
...
static int ClericExp[MAX_LEVELS+1] =
{
	0,	// Level 1
	500,	// Level 2
	1000,	// Level 3
...
static int NecroExp[MAX_LEVELS+1] =
{
	0,	// Level 1
	500,	// Level 2
	1000,	// Level 3
...
static int TheifExp[MAX_LEVELS+1] =
{
	0,	// Level 1
	500,	// Level 2
	1000,	// Level 3
...
static int FindLevel(edict_t *WhichPlayer)
{
	int	*Chart;
...
static void PF_AwardExperience(void)
{
...
//	char	temp[200];
	...
	IsPlayer = (q_strcasecmp(PR_GetString(ToEnt->v.classname), "player") == 0);
