/*
	...
	$Header: /cvsroot/uhexen2/hexenworld/Client/screen.c,v 1.44 2008/02/07 09:27:24 sezero Exp $
*/
...
static void SCR_EraseCenterString (void)
{
	...
	scr_copytop = 1;
	Draw_TileClear (0, y, vid.width, q_min(8*scr_erase_lines, vid.height - y - 1));
}
*/
