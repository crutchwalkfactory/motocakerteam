    ...
    :MyBaseDlg()
{
  ...
  setMainWidgetTitle ( "zTextViewer" );
  ...
  myLabel = new QLabel ( QString ( "<qt><img src=%1/zTextViewer_usr.png><br>"
                                   "<font size=\"+1\">zTextViewer </font><font size=\"-1\">"
                                   "  v0.4<br><br>Suport OpenOffice and MS Word 2010 documents.<br>"
                                   "<br>Original version by BeZ.<br>(C) 2010. CepiPerez"
