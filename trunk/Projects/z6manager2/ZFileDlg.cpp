  ...
  :MyBaseDlg()
{
  ...
  browser->clear();
	...
	nombres += "mod_std"; nombres += "moto_source_std"; nombres += "motosync_std"; nombres += "mp_radio_std";
	...
	nombres += "sidebar_std"; nombres += "sim_apps_std"; nombres += "skin_std"; nombres += "slider_std";
	nombres += "softbox_std"; nombres += "stored_page_std"; nombres += "task_list_std"; nombres += "themes_std";
	nombres += "tones_std"; nombres += "tweaks_std"; nombres += "utility_std"; nombres += "vid_camera_std";
